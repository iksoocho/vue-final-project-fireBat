...
INSERT INTO `T_BOARD_BOARD` (`no`, `title`, `writer`, `content`, `created_date`, `update_date`)
VALUES 
...
INSERT INTO `T_COMMENT_BORAD` (`no`, `writer`, `content`, `created_date`, `update_date`, `bno`)
VALUES 
...
select * from T_BOARD_BORAD;
select * from T_COMMENT_BORAD;
